...
import "./Primecards.css";

function Primecards(props) {
  return (
    <>
      <Card>
        ...
        <Card.Body>
          <div className="body-inner">
            <Card.Title>{props.mTitle}</Card.Title>
            <Card.Text>
              <ListGroup horizontal>
                <ListGroup.Item>{props.season}</ListGroup.Item>
                <ListGroup.Item>
                ...
                <ListGroup.Item>{props.adult}</ListGroup.Item>
              </ListGroup>
            </Card.Text>
          </div>
          <Button variant="link">
